...
<div class="container border mt-4 p-4">
	...
	<form action="index.php" method="post">
		...
		<div class="row mb-2">
			...
			<div class="col-lg-8"><input type="number" name="dada" class="form-control" min="0" required></div>
		</div>

		<div class="row mb-2">
			<div class="col-lg-4">Jumlah Paha Ayam:</div>
			<div class="col-lg-8"><input type="number" name="paha" class="form-control" min="0" required></div>
		</div>

		<div class="row mb-3">
			<div class="col-lg-4">Jumlah Nasi:</div>
			<div class="col-lg-8"><input type="number" name="nasi" class="form-control" min="0" required></div>
		</div>
